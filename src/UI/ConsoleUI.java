...
*
* Copyright 2012 Milan Draganic, Tomislav Novak - NetAkademija
*/
package UI;
...
/**
 * Sucelje za komunikaciju sa korisnikom temeljeno na konzoli. Korisniku je u
 * mogucnosti odabrati i igranje jedne od igara.
 *
 * @author Milan Draganic Tomislav Novak
 */
...
//				System.out.println(showHighScores());
	...
	/**
	 * Metoda koja stvara listu igraca poredanih od onoga sa najvecim rezultatom
...
//	}
	...
	private static void boardGamesUI() {
		while (true) {
			System.out.println(
					"Odaberite igru koju zelite igrati:\n [1] TicTacToe \n [2] ConnectFour\n [3] Reversi\n [p] Povratak na glavni meni. \n [x] Izlaz!");
	 ...
	 * koja kreira i pokrece jednu Board igru. Metoda slijedi proceduru: <br>
	 * 1. kreiranje igre i igraca<br>
	 * 2. pokretanje igre<br>
	 * 3. ispis dobrodoslice i uputa<br>
	 * 4. igranje dok god postoje slobodni potezi<br>
	 * 5. objava rezultata igre i pozdrav<br>
	 *
	 * @param type
	 *            tip igre koju korisnik zeli igrati. Vidi boardGamesUI() metodu
	 *            i popis raspolozivih igara.
	 */
...
//				DataBase.getInstance().updatePlayer(winner);// osvježi ga u
	...
	/**
	 * Metoda koja radi objekt igraca Board-type igara. Ovisno o tome kakav tip
	 * igraca trebamo stvara se novi objekt igraca.
	 *
	 * @param game
	 *            Igra za koju se stvara igrac.
	 * @return objekt igraca.
	 */
